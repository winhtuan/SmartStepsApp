...
final offlineSituationDetails = <SituationDetail>[
  _lesson(
    ...
    practicePrompt:
        'Hãy kiểm tra đồ chơi của bé thường xuyên xem có bị lỏng ốc hoặc có những thứ rơi ra ngoài không.',
    riskAlert:
  ...
  _lesson(
    ...
    correctStory:
        'Bé quay lưng lại với ổ điện và tiếp tục chơi ở nơi an toàn. Reward: Bé biết tránh xa ổ điện! +1 Safety Star.',
    correctFeedback:
    ...
    practicePrompt:
        'Hôm nay, hãy cùng bé đi một vòng quanh nhà và chỉ cho bé các vị trí ổ điện cấm chạm vào.',
    riskAlert:
  ...
  _lesson(
    ...
    practicePrompt:
        'Hãy chỉ cho bé phích nước hoặc bình thủy trong nhà và dạy bé từ "Nóng" kèm hành động rụt tay lại.',
    riskAlert:
  ...
  _lesson(
    ...
    practicePrompt:
        'Ba mẹ hãy cùng bé tạo ra một mật khẩu bí mật. Dặn bé chỉ đi theo ai đọc đúng mật khẩu này.',
    riskAlert:
  ...
  _lesson(
    ...
    practicePrompt:
        'Đóng vai bạn bè rủ bé làm việc sai, xem bé có dám từ chối ba mẹ không.',
    riskAlert:
  ...
  _lesson(
    ...
    practicePrompt:
        'Ba mẹ thử cố tình đánh rơi một tờ tiền lẻ trong phòng bé, xem bé sẽ giữ lấy hay đem trả lại.',
    riskAlert:
  ...
  _lesson(
    ...
    practicePrompt: 'Hôm nay khi ra đường hãy hỏi bé đèn màu nào được đi.',
  ...
  _lesson(
    ...
    practicePrompt: 'Hãy hỏi bé: nếu bị lạc trong siêu thị thì con sẽ làm gì?',
  ...
  _lesson(
    ...
    practicePrompt:
        'Hãy hỏi bé: nếu đồ chơi rơi xuống hồ nước thì con sẽ làm gì?',
