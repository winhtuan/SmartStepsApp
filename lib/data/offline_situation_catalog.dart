...
final offlineSituationDetails = <SituationDetail>[
  _lesson(
    ...
    practicePrompt: 'Nếu con nhặt được một viên bi hoặc vật nhỏ lạ trên sàn, con nên làm gì?',
    riskAlert:
  ...
  _lesson(
    ...
    practicePrompt: 'Con có được tự ý dùng tay hoặc đồ vật chọc vào ổ cắm điện không?',
    riskAlert:
  ...
  _lesson(
    ...
    practicePrompt: 'Khi nhìn thấy phích nước hoặc bình nước nóng, con nên làm gì?',
    riskAlert:
  ...
  _lesson(
    ...
    practicePrompt: 'Nếu một người lạ gọi đúng tên con và bảo lên xe để chở về với bố mẹ, con có đi theo không?',
    riskAlert:
  ...
  _lesson(
    ...
    practicePrompt: 'Nếu bị bạn bè rủ rê hoặc thách thức chơi một trò nguy hiểm, con có làm theo không?',
    riskAlert:
  ...
  _lesson(
    ...
    practicePrompt: 'Nếu nhặt được chiếc ví hoặc đồ chơi của người khác đánh rơi, con sẽ làm gì?',
    riskAlert:
  ...
  _lesson(
    ...
    practicePrompt: 'Nếu chẳng may bị lạc mất bố mẹ trong siêu thị, con nên làm gì?',
