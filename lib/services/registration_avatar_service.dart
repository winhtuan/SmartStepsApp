...
class RegistrationAvatarService {
  ...
  static const _avatarDefinitions = [
    RegistrationAvatar(
      ...
      assetPath: 'assets/images/avatars/cat.png',
    ),
    RegistrationAvatar(
      label: 'Chó',
      color: Color(0xFFFFF0AE),
      storagePath: 'avatars/dog.png',
      assetPath: 'assets/images/avatars/dog.png',
    ),
    RegistrationAvatar(
      label: 'Voi',
      color: Color(0xFFD8F1FF),
      storagePath: 'avatars/elephant.png',
      assetPath: 'assets/images/avatars/elephant.png',
    ),
    RegistrationAvatar(
      label: 'Thỏ',
      color: Color(0xFFFFDDEB),
      storagePath: 'avatars/rabbit.png',
      assetPath: 'assets/images/avatars/rabbit.png',
    ),
    RegistrationAvatar(
      label: 'Gấu',
      color: Color(0xFFD9F7E8),
      storagePath: 'avatars/bear.png',
      assetPath: 'assets/images/avatars/bear.png',
    ),
    RegistrationAvatar(
      label: 'Cáo',
      color: Color(0xFFFFD7AE),
      storagePath: 'avatars/fox.png',
      assetPath: 'assets/images/avatars/fox.png',
    ),
  ];
